  ...
  render() {
    ...
    return (
      <div className='order-dashboard'>
        <SubPage
          title='Your Orders'
          actionTitle={user.role === ROLES.Admin ? 'Customer Orders' : null}
          handleAction={() =>
            user.role === ROLES.Admin && history.push('/dashboard/orders/customers')
          }
          actionTitle1={user.role === ROLES.Merchant ? 'Merchant Orders' : null}
          handleAction1={() =>
            user.role === ROLES.Merchant && history.push('/dashboard/orders/merchants')
          }
        >
          <OrderSearch
